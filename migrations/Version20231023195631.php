 ...
 */
final class Version20231023195631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" ADD codepostale VARCHAR(5) NOT NULL');
        $this->addSql('ALTER TABLE "user" ADD telephone VARCHAR(12) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" DROP codepostale');
